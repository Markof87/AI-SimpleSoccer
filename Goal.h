...
public:
	...
	//Given the current ball position and the previous ball position, this method returns true 
	//if the ball has crossed the goal line and increments m_iNumGoalsScored.
